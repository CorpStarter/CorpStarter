 ...
 */
final class Version20260409093136 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE project (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, requested_budget NUMERIC(10, 2) NOT NULL, allocated_budget NUMERIC(10, 2) NOT NULL, illustration_path VARCHAR(255) NOT NULL, creation_date DATETIME NOT NULL, status_id INT DEFAULT NULL, requester_id INT DEFAULT NULL, approver_id INT DEFAULT NULL, INDEX IDX_2FB3D0EE6BF700BD (status_id), INDEX IDX_2FB3D0EEED442CF4 (requester_id), INDEX IDX_2FB3D0EEBB23766C (approver_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('CREATE TABLE users (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, first_name VARCHAR(255) NOT NULL, token VARCHAR(255) DEFAULT NULL, token_date DATETIME DEFAULT NULL, email VARCHAR(255) NOT NULL, password_hash VARCHAR(255) NOT NULL, email_confirmed TINYINT NOT NULL, terms_accepted TINYINT NOT NULL, creation_date DATETIME NOT NULL, user_type_id INT DEFAULT NULL, INDEX IDX_1483A5E99D419299 (user_type_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE project ADD CONSTRAINT FK_2FB3D0EE6BF700BD FOREIGN KEY (status_id) REFERENCES project_status (id)');
        $this->addSql('ALTER TABLE project ADD CONSTRAINT FK_2FB3D0EEED442CF4 FOREIGN KEY (requester_id) REFERENCES users (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE project DROP FOREIGN KEY FK_2FB3D0EEED442CF4');
