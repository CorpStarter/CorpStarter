 ...
 */
class getUserTypesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\UserTypesRepository' shared autowired service.
     *
     * @return \App\Repository\UserTypesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'UserTypesRepository.php';

        return $container->privates['App\\Repository\\UserTypesRepository'] = new \App\Repository\UserTypesRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
