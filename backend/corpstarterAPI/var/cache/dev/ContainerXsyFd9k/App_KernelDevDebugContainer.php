...
class App_KernelDevDebugContainer extends Container
{
    ...
    {
        return $container->services['api_platform.cache.metadata.operation'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('3NoGu3r6jr', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    {
        return $container->services['api_platform.cache.metadata.property'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('-xtX5dmIXh', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    {
        return $container->services['api_platform.cache.metadata.resource'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('1ONzXu6f42', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    {
        return $container->services['api_platform.cache.metadata.resource_collection'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('kYRZu4NO7k', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    {
        return $container->services['cache.security_is_csrf_token_valid_attribute_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('DmumZ8X7Vd', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    {
        return $container->services['cache.security_is_granted_attribute_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('PvJatTdg3X', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $b->allowControllers(['App\\Kernel', 'App\\Controller\\AdminController', 'App\\Controller\\AuthController', 'App\\Controller\\ProjectController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    {
        return $container->privates['cache.security_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('0t4s55Wpk1', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    protected static function getDoctrine_Orm_DefaultConfigurationService($container)
    {
        ...
        $instance->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'App\\Repository\\ProjectStatusRepository' => ['privates', 'App\\Repository\\ProjectStatusRepository', 'getProjectStatusRepositoryService', true],
            'App\\Repository\\UserTypesRepository' => ['privates', 'App\\Repository\\UserTypesRepository', 'getUserTypesRepositoryService', true],
            ...
            'App\\Repository\\UserTypesRepository' => '?',
    ...
    protected static function getSerializerService($container)
    {
        ...
        $f = ($container->privates['api_platform.metadata.operation.metadata_factory.cached'] ?? self::getApiPlatform_Metadata_Operation_MetadataFactory_CachedService($container));
        ...
        $k = new \ApiPlatform\OpenApi\Serializer\LegacyOpenApiNormalizer(new \ApiPlatform\OpenApi\Serializer\ApiGatewayNormalizer(new \ApiPlatform\OpenApi\Serializer\OpenApiNormalizer(new \Symfony\Component\Serializer\Serializer([new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer(NULL, NULL, $h, $i)], [$j])), $container->parameters['api_platform.serializer.default_context']), $container->parameters['api_platform.serializer.default_context']);
        ...
        $q = new \ApiPlatform\JsonLd\Serializer\ItemNormalizer($a, $m, $b, $c, $n, $d, $h, $l, $o, $container->parameters['api_platform.serializer.default_context'], $e, NULL, $f, $p);

        $r = new \ApiPlatform\JsonLd\Serializer\ErrorNormalizer($q, $container->parameters['api_platform.serializer.default_context']);
        $s = new \ApiPlatform\Serializer\ItemNormalizer($m, $b, $c, $n, $h, $l, $o, NULL, $a, $e, [], NULL, $p);
        $t = new \Symfony\Component\Serializer\NameConverter\MetadataAwareNameConverter($o);
        $u = new \Symfony\Component\Serializer\Mapping\ClassDiscriminatorFromClassMetadata($o);
        $v = new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer($o, $l, $h, $i, $u, NULL, [], $i);
        ...
        $instance = new \Symfony\Component\Serializer\Serializer([new \Symfony\Component\Serializer\Normalizer\UnwrappingDenormalizer($h), $k, $k, new \ApiPlatform\Serializer\ConstraintViolationListNormalizer([], $l), new \ApiPlatform\Hydra\Serializer\ConstraintViolationListNormalizer([], $l, $container->parameters['api_platform.serializer.default_context']), $k, new \ApiPlatform\Symfony\Validator\Serializer\ValidationExceptionNormalizer($r, $l), new \ApiPlatform\Hydra\Serializer\DocumentationNormalizer($a, $m, $b, $n, $g, $l, $container->parameters['api_platform.serializer.default_context'], true), new \ApiPlatform\Hydra\Serializer\EntrypointNormalizer($a, $c, $g), new \ApiPlatform\Symfony\Validator\Serializer\ValidationExceptionNormalizer($s, $l), $r, new \Symfony\Component\Serializer\Normalizer\ProblemNormalizer(true, $container->parameters['api_platform.serializer.default_context'], NULL), new \Symfony\Component\Serializer\Normalizer\UidNormalizer($container->parameters['api_platform.serializer.default_context']), $q, $s, new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer($container->parameters['api_platform.serializer.default_context']), new \Symfony\Component\Serializer\Normalizer\ConstraintViolationListNormalizer($container->parameters['api_platform.serializer.default_context'], $t), new \Symfony\Component\Serializer\Normalizer\MimeMessageNormalizer(new \Symfony\Component\Serializer\Normalizer\PropertyNormalizer($o, $t, $i, $u, NULL, [])), new \Symfony\Component\Serializer\Normalizer\DateTimeZoneNormalizer(), new \Symfony\Component\Serializer\Normalizer\DateIntervalNormalizer($container->parameters['api_platform.serializer.default_context']), new \Symfony\Component\Serializer\Normalizer\FormErrorNormalizer(), new \Symfony\Component\Serializer\Normalizer\BackedEnumNormalizer(), new \Symfony\Component\Serializer\Normalizer\NumberNormalizer(), new \Symfony\Component\Serializer\Normalizer\DataUriNormalizer(($container->privates['mime_types'] ?? self::getMimeTypesService($container))), new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer(NULL, NULL, $container->parameters['api_platform.serializer.default_context']), new \ApiPlatform\Hydra\Serializer\CollectionFiltersNormalizer(new \ApiPlatform\Hydra\Serializer\PartialCollectionViewNormalizer(new \ApiPlatform\Hydra\Serializer\CollectionNormalizer($d, $n, $c, $container->parameters['api_platform.serializer.default_context']), 'page', 'pagination', $a, $h, 1, $container->parameters['api_platform.serializer.default_context']), $a, $n, ($container->privates['api_platform.filter_locator'] ??= new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [], [])), $container->parameters['api_platform.serializer.default_context']), new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), new \ApiPlatform\JsonLd\Serializer\ObjectNormalizer($v, $c, $d), new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer($o, $t, $h, $i, $u, NULL, $container->parameters['api_platform.serializer.default_context'], $i), $v], [new \Symfony\Component\Serializer\Encoder\XmlEncoder($container->parameters['api_platform.serializer.default_context']), $j, $w, new \Symfony\Component\Serializer\Encoder\CsvEncoder($container->parameters['api_platform.serializer.default_context']), new \ApiPlatform\Serializer\JsonEncoder('jsonopenapi', NULL), new \ApiPlatform\Serializer\YamlEncoder('yamlopenapi', $w), new \ApiPlatform\Serializer\JsonEncoder('jsonld', NULL), new \ApiPlatform\Serializer\JsonEncoder('jsonproblem')], $container->parameters['api_platform.serializer.default_context']);
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'api_platform.class_name_resources' => [
                ...
                2 => 'App\\Entity\\Project',
                3 => 'App\\Entity\\ProjectStatus',
                4 => 'App\\Entity\\UserTypes',
                5 => 'App\\Entity\\Users',
            ],
