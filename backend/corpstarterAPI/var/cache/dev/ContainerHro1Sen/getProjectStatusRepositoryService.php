 ...
 */
class getProjectStatusRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ProjectStatusRepository' shared autowired service.
     *
     * @return \App\Repository\ProjectStatusRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ProjectStatusRepository.php';

        return $container->privates['App\\Repository\\ProjectStatusRepository'] = new \App\Repository\ProjectStatusRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
