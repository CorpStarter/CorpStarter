 ...
 */
final class Version20260324133007 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE project (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, requested_budget NUMERIC(5, 2) DEFAULT NULL, illustration_path VARCHAR(255) DEFAULT NULL, allocated_budget NUMERIC(5, 2) DEFAULT NULL, creation_date DATETIME NOT NULL, approver_id INT DEFAULT NULL, status_id INT NOT NULL, INDEX IDX_2FB3D0EEBB23766C (approver_id), INDEX IDX_2FB3D0EE6BF700BD (status_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
